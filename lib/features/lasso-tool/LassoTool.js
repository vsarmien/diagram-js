...
var hasSecondaryModifier = require('../../util/Mouse').hasSecondaryModifier,
    isSecondaryModifier = require('../../util/Mouse').isSecondaryModifier;
...
/**
 * A multi selection lasso tool.
 */
function LassoTool(eventBus, canvas, dragging, elementRegistry, selection) {

  Tool.call(this, eventBus, { prefix: 'lasso', cursor: LASSO_TOOL_CURSOR });
...
inherits(LassoTool, Tool);

module.exports = LassoTool;

LassoTool.prototype.activatesOnKey = function(keyEvent) {
  return isSecondaryModifier(keyEvent);
};
